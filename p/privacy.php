...
<div id="page-wrapper">
    ...
    <p>
        If you would like your name removed or changed, please contact us: <?php insert_email() ?>
    </p>
    ...
    <p>
        If you have any other questions or concerns, please contact us: <?php insert_email() ?>
    </p>

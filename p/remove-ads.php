...
<div id="page-wrapper">
    ...
    <p>
        Don't like ads? Neither do we. <a href="https://www.patreon.com/TextureHaven/overview">Donate $1</a> (or more) to <?php echo $GLOBALS['SITE_NAME']; ?> to enable an ad-free experience across the whole site, helping us fund future <?php echo $GLOBALS['CONTENT_TYPE_NAME']; ?> at the same time.
    </p>
